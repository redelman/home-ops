...
resource "proxmox_virtual_environment_vm" "talos-tmp-1" {
  name      = "talos-tmp-1"
  description = "Managed by Terraform"
...
resource "proxmox_virtual_environment_vm" "talos-tmp-2" {
  name      = "talos-tmp-2"
  description = "Managed by Terraform"
  tags        = ["terraform", "talos", "quok"]
